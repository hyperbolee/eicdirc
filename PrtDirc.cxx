...
int main(int argc,char** argv)
{
	...
	G4String macro, events, geometry,evType, radiator, physlist, outfile, pixsize("3"), 
	...
	for ( G4int i=1; i<argc; i=i+2 ) {
	    ...
	    else if ( G4String(argv[i]) == "-pix" ) pixsize   = argv[i+1];
		else {
			PrintUsage();
			return 1;
		}
	...
	if(pixsize.size()) PrtManager::Instance()->SetPixelSize(atof(pixsize));
